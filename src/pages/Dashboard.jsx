...
export default function Dashboard() {
  ...
  <div className="w-full min-h-screen p-8 bg-white">     
   <Breadcrumb title="Dashboard" breadcrumb="Dashboard">
      ...
      <div id="dashboard-container" className="grid gap-4 mt-6 sm:grid-cols-2 md:grid-cols-3">
        {Data.map((order) => {
      ...
      <h2 className="text-xl font-bold mt-10 mb-4">Statistik Pengunjung Mingguan</h2>
      <div className="bg-white p-4 rounded-xl shadow-md">
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={Datapengunjung}>
            ...
            <YAxis />
            <Tooltip />
            <Line type="monotone" dataKey="pengunjung" stroke="#3B82F6" strokeWidth={3} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
